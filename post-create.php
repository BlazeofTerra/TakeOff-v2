...
if(!isset($_SESSION['postCreate'])) {
	$_SESSION['postCreate'] = array("image_1"=>"", "image_2"=>"", "image_3"=>"", "image_4"=>"", "image_5"=>"", "image_6"=>"");
} else {
	...
	<body>
		<div id="outerWrapper">
			<div id="wrapper">
				...
				<form id="formWrapper" action="Post-Create-Preview.php" method="post">
					<h1>Post Creation</h1>
					...
					<div class="inputContainer">
						...
						<div class="inputRow"><label for="blurb">Description (250 chars max):</label><textarea id="blurb" type="text" name="blurb" maxlength="250"><?php if(isset($blurb) and $blurb != "") { echo $blurb; } ?></textarea></div>
					</div>
					<div class="inputContainer">
					...
					<div class="inputContainer">
						...
						<div class="descHolder">
							<textarea class="description" name="description"><?php if(isset($description) and $description != "") { echo $description; } ?></textarea>
						</div>
					</div>
